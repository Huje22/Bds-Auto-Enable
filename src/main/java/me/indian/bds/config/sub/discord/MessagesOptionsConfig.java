...
public class MessagesOptionsConfig extends OkaeriConfig {
    ...
    private boolean sendJoinMessage = false;
    @Comment({""})
    @Comment({"Wysyłać wiadomość o opuszczeniu gracza"})
    private boolean sendLeaveMessage = false;
    @Comment({""})
    @Comment({"Wysyłać wiadomość gracza"})
    private boolean sendPlayerMessage = false;
    @Comment({""})
    @Comment({"Wysyłać wiadomość o śmierci gracza"})
    private boolean sendDeathMessage = false;
    @Comment({""})
    @Comment({"Wysyłać wiadomość o wyłączeniu servera"})
    private boolean sendDisabledMessage = false;
    @Comment({""})
    @Comment({"Wysyłać wiadomość o wyłączaniu servera"})
    private boolean sendDisablingMessage = false;
    @Comment({""})
    ...
    private boolean sendEnabledMessage = false;
    @Comment({""})
